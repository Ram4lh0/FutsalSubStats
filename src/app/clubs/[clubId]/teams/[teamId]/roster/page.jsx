  ...
  return (
    <>
      <div className="toolbar">
        ...
        <button className="btn btn--primary" onClick={() => router.push(`${base}/players/new`)}>
          Criar jogador
        </button>
      </div>
            ...
            {linhas.map((p) => {
              ...
              return (
                <tr key={p.id} className={p.isActive ? '' : 'is-muted'}>
                  ...
                  <td>
                    <a className="link" onClick={() => router.push(`${base}/players/${p.id}`)}>
                      {p.name}
                    </a>
                  </td>
                  ...
                  <td className="right">
                    <button
                      ...
                      onClick={() => router.push(`${base}/players/${p.id}`)}
                    >
                      Abrir
                    </button>
