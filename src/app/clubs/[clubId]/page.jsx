  ...
  return (
    <>
      <PageHead
        ...
        actions={
          <>
            <button className="btn btn--ghost" onClick={() => router.push(`/clubs/${clubId}/edit`)}>
              Editar clube
            </button>
            <button
              className="btn btn--primary"
              onClick={() => router.push(`/clubs/${clubId}/teams/new`)}
            >
              Criar escalão
            </button>
          </>
          ...
          {cartoes.map(({ team, ativos, jogos, ultimo }) => (
            ...
            >
              <button
                ...
                onClick={() => router.push(`/clubs/${clubId}/teams/${team.id}/edit`)}
              >
                Editar
              </button>
              ...
              <div className="club-card__actions">
                <button
                  ...
                  onClick={() => router.push(`/clubs/${clubId}/teams/${team.id}/roster`)}
                >
                  Plantel
                </button>
                <button
                  className="btn btn--primary"
                  onClick={() => router.push(`/clubs/${clubId}/teams/${team.id}`)}
                >
                  Abrir escalão
                </button>
              </div>
